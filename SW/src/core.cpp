...
void core::decode(ctrl_intf_t *ctrl_intf_id, ctrl_intf_private_t* ctrl_intf_private)
{
    ...
    uint32_t funct3_ex = inst_field::funct3(ctrl_intf_id->inst_ex);
    ...
    decode_pipeline_ctrl(ctrl_intf_id);

    decode_store_mask(ctrl_intf_id);

    decode_branch_resolution(ctrl_intf_id);    
